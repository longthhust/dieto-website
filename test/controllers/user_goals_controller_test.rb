...
class UserGoalsControllerTest < ActionController::TestCase
  ...
  test "should create user_goal" do
    assert_difference('UserGoal.count') do
      post :create, user_goal: { comment: @user_goal.comment, user_id: @user_goal.user_id, weight: @user_goal.weight }
    end
  ...
  test "should update user_goal" do
    patch :update, id: @user_goal, user_goal: { comment: @user_goal.comment, user_id: @user_goal.user_id, weight: @user_goal.weight }
    assert_redirected_to user_goal_path(assigns(:user_goal))
  end
