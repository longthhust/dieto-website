...
class ActivityLogsControllerTest < ActionController::TestCase
  ...
  test "should create activity_log" do
    assert_difference('ActivityLog.count') do
      post :create, activity_log: { content: @activity_log.content, user_id: @activity_log.user_id }
    end
  ...
  test "should update activity_log" do
    patch :update, id: @activity_log, activity_log: { content: @activity_log.content, user_id: @activity_log.user_id }
    assert_redirected_to activity_log_path(assigns(:activity_log))
  end
